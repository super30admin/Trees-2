...
class Solution:
    def sumNumbers(self, root: TreeNode) -> int:
        """
        Traverse through every elem if there is no left and no right add the sum and return the total sum.
        If not multiply the curr sum * 10 and add current value
"""

...
class Solution(object):
    ...
    def buildTree(self, inorder, postorder):
        ...
        curr_val = 0
        #         if length of postorder is 0 then return null
        if len(postorder) == 0:
            return None
        #         take current root of the tree/subtree as lats element in postorder array
        ...
        #
        #       call the function recursively and assign left and right child of the root  accordingly considering the range in given array
